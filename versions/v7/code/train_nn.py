...
def main():
    ...
    ap.add_argument("--view", default="A", choices=["A", "B"],
                    help="which fe.py feature view to fit on -- must match "
                         "NN_VIEW in train_v4.py")
    ...
    X = fe.build_features(df, ctx, extras=(args.view == "B"))
